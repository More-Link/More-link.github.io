 ...
 */
define(['jquery', 'util', 'cf/site_config', 'part/templates', 'i18n/config', 'i18n/controller'], function ($, util, site_config, templates, i18n_config, i18n_controller) {
    ...
    function footerGenerator() {
        ...
        //获取levelMap
        var levelMap = util.extend.Obj(util.extend.Obj({}, clangData.header.solution.classify), clangData.header.product.classify);
