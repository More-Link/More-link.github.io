    ...
    return {
        bindEvents: function () {
            ...
            main_nav_box.on('click', '.nav_control', function () {
                ...
                var $this = $(this), parent_level_box = $this.parents('.nav_level_box');
                ...
                var $this = $(this), langTxt = $this.text(), langTag = $this.attr('value');
            ...
            function generateShowBox(target) {
                ...
                //只要初始数据加载后，数据肯定是有的
                    ...
                    solData = i18n_controller.translateJSONGetter('solutions_all')[classify],    //software的所有对象
