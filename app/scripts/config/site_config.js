...
define(['util'],(util)=>{
    ...
    var redirection = function () {
    	if (currentRoute && currentRoute.static){//仅对静态路由进行重定向
    ...
    var matchCurrentPath = function (force) {
    	...
    	var targetRoute = null,cuPath = util.getPathName(),cHash = util.getHashName();
    ...
    return {
        ...
        //验证是否在某个路径下
        inPage: function (route,language) {
            var flag = false,lang = language || util.getLocalLanguage();
